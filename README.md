...
- **Offline Engine:** CACHE → ANTRE (IndexedDB `mar_sum_v1`) → SINKRON (Background Sync / FIFO). Idempoten via `op_id` + `ProcessedOps` (dedup di backend).
- **Peran UI:** 
...
## Karakteristik Model Bisnis SUM
